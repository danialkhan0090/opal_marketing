...
const RealEstateProject = () => {
  const societies = [
    ...
    {
      id: 3,
      image: "/Images/d0587c6e-1520-40fb-9855-4ffb559c3ad0.png",
    ...
    {
      id: 4,
      image: "/Images/2566a012-93d1-4bb5-a03d-6471a47986f9.png",
      title: "NOVA CITY",
      price: "0.9 Million",
    ...
    {
      id: 5,
      image: "/Images/554c90ae-0319-457e-b707-8c8570c88ed7.png",
    ...
    {
      id: 6,
      image: "/Images/c17ab826-c3d4-4c1d-ad90-8f64dedf11fa.png",
      title: "RUDN ENCLAVE",
      price: "0.7 Million",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section
        ...
        style={{
          backgroundImage: `url('/Images/554c90ae-0319-457e-b707-8c8570c88ed7.png')`,
        }}
      >
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto">
            Opal Marketing is proud to represent some of the most prestigious
            real estate developments in Pakistan. We offer a diverse portfolio
            of properties to suit every need and budget.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-700 mb-8 max-w-3xl mx-auto">
            Our expert team is ready to guide you through the best investment
            options available in the market. Get personalized advice based on
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            <Link to="/sky-projects">
              <Button
                variant="outline"
                className="border-[#FFA500] text-[#FFA500] hover:bg-[#FFA500] hover:text-white px-8 py-5 rounded-none"
              >
                EXPLORE PROJECTS
              </Button>
            </Link>
